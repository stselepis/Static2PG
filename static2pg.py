...
#ports
gdf_zone = gdf_zone.to_crs(epsg=3857)  # Web Mercator (units in meters)
gdf_zone['polygon_geom'] = gdf_zone.geometry.buffer(gdf_zone['range'])
gdf_zone = gdf_zone.set_geometry('polygon_geom').to_crs(epsg=4326)
#berths
